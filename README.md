...
- [No Live Demo Link yet](<replace-with-your-deployment-URL>)
...
Follow instuctions on PostgreSQL official website.
...
git clone https://github.com/Obimbo07/vet-clinic
...
To run the project use postgresSQL to check for data in database.
